    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data Ekspor Hewan</strong>
            </div>
            <div class="card-body">
                <form action="/eksporHewan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editEksporHewan as $item)
                                <tr>
                                    <td>
                                        <div class="mb-2 col-auto">
                                            <input type="hidden" name="id[]" value="{{ $item->id_komoditas_hewan }}">
                    ...
                    <a href="/eksporHewan" class="btn btn-sm btn-danger">
