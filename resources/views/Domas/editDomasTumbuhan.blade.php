    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data DOMAS Tumbuhan</strong>
            </div>
            <div class="card-body">
                <form action="/domasTumbuhan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editDomasTumbuhan as $item)
                                <tr>
                                    <td>
                    ...
                    <a href="/domasTumbuhan" class="btn btn-sm btn-danger">
