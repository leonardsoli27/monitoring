    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data DOMAS Hewan</strong>
            </div>
            <div class="card-body">
                <form action="/domasHewan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editDomasHewan as $item)
                                <tr>
                                    <td>
                    ...
                    <a href="/domasHewan" class="btn btn-sm btn-danger">
