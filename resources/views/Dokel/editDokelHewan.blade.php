    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data DOKEL Hewan</strong>
            </div>
            <div class="card-body">
                <form action="/dokelHewan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editDokelHewan as $item)
                                <tr>
                                    <td>
                    ...
                    <a href="/dokelHewan" class="btn btn-sm btn-danger">
