    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data DOKEL Tumbuhan</strong>
            </div>
            <div class="card-body">
                <form action="/dokelTumbuhan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editDokelTumbuhan as $item)
                                <tr>
                                    <td>
                    ...
                    <a href="/dokelTumbuhan" class="btn btn-sm btn-danger">
