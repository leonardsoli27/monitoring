    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Edit Data Impor Hewan</strong>
            </div>
            <div class="card-body">
                <form action="/imporHewan/edit" method="POST">
                    @method('put')
                    @csrf
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                @foreach ($editImporHewan as $item)
                                <tr>
                                    <td>
                    ...
                    <a href="/imporHewan" class="btn btn-sm btn-danger">
