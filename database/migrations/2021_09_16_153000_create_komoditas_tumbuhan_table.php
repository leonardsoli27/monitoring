...
class CreateKomoditasTumbuhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('komoditas_tumbuhan', function (Blueprint $table) {
            $table->id('id_komoditas_tumbuhan');
    ...
    {
        Schema::dropIfExists('komoditas_tumbuhan');
    }
}
